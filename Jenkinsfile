...
"""
    ...
    parameters {
        ...
        text(name: 'parameters', defaultValue : '', description: "By leaving this field as empty, default cluster will be created in the region US Central1 (https://git.pega.io/projects/SM/repos/gcp-gke-terraform/browse/terraform.tfvars.template). Only the required parameters can be overridden by visiting the link (https://git.pega.io/projects/SM/repos/gcp-gke-terraform/browse/provisioning/terraform.tfvars.template). ")
